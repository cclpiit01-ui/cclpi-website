  ...
  return (
    <div className={`${BANNER_BASE} bg-[#013F99] group`}>
      ...
      <div className="absolute inset-0 z-0">
        <div
          className="absolute inset-0 opacity-20 grayscale transition-transform duration-[2000ms] group-hover:scale-110"
          style={{
        ...
        <div className="max-w-3xl">
          ...
          <Reveal direction="up">
            <h1 className="text-white font-black leading-tight text-4xl md:text-6xl lg:text-7xl uppercase tracking-tighter mb-8">
              FAST & <span className="text-brand-accent italic">RELIABLE</span>
              <br />
              CLAIMS PROCESS
            </h1>
          </Reveal>
          ...
          <Reveal direction="up" delay={0.2}>
            <div className="flex items-start gap-4 mb-10 border-l-8 border-brand-accent pl-6">
              <p className="text-white/90 text-lg md:text-xl font-medium max-w-xl leading-relaxed">
                ...
                ensures that your benefits are delivered when you need them
                most.
              </p>
            </div>
          </Reveal>
          ...
          <Reveal direction="up" delay={0.4}>
            <div className="mt-10 relative z-50">
                ...
                className="inline-flex items-center bg-brand-accent hover:bg-white text-brand-primary font-black py-4 px-10 rounded-full shadow-2xl transition-all duration-300 uppercase tracking-widest text-sm hover:-translate-y-1 hover:shadow-brand-accent/40 active:scale-95"
              >
                See Claims Services
              </Link>
            </div>
