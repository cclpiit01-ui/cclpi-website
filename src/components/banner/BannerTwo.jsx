...
const BannerTwo = () => {
  return (
    <div className={`${BANNER_BASE} bg-[#013F99]`}>
      ...
      <div className="absolute inset-0 z-0">
        <img
          src={agentImg}
          alt="CCLPI Agent"
          className="w-full h-full object-contain sm:object-cover lg:object-contain object-right grayscale-[10%] opacity-90 transition-transform duration-1000 group-hover:scale-105"
        />
