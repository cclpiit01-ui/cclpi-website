...
export default function SalesCounselorCard() {
  ...
  useEffect(() => {
    const fetchCounselor = async () => {
      try {
        // The URL param is the obfuscated token generated by the admin
        // portal (encodeCounselorId), so decode it back to the real id_no
        // before looking the record up.
        const actualIdNo = decodeCounselorId(id);
        if (!actualIdNo) {
          setNotFound(true);
          setLoading(false);
          return;
